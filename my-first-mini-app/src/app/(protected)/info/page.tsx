        ...
        <div className="grid w-full gap-4">
          ...
          <div className="p-4 border border-gray-700 rounded-lg">
            ...
            <div className="grip w-full gap-4">
              ...
              <br />
            <a href="https://t.me/+Q6FBHtiGMdU1N2Zh" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-1 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Telegram</a>
               <p></p>
              <br />
            <a href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-1 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Twitter</a>
             </div> 
         </div>       
        </div>
      </Page.Main>
