...
export default function Navigation() {
  ...
  return (
    ...
    <div className="w-full">
      <nav className="flex items-end justify-around max-w-s mx-auto pt-20 pb-0">
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={clsx(
                ...
                'flex flex-col items-end justify-center gap-1 w-12 h-12 rounded-full transition-all duration-300 ease-in-out',
                {
